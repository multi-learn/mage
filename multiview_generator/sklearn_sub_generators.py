...
class MultiViewSklearnSubProblemsGenerator(MultiViewSubProblemsGenerator):
    r"""
    ...
    def generate_multi_view_dataset(self, ):
        ...
        * finally, for each view it generates a monview dataset according to the configuration
        ...
        for class_index, indices in enumerate(self.class_sample_indices):
            self.y[indices] = class_index

        self.view_data = []
        self._gen_sample_indices()
