...
author = u'Baptiste BAUVIN and Dominique BENIELLI and Sokol KOCO and Cécile CAPPONI'
...
latex_documents = [
    (master_doc, 'SMuDGE.tex', u'SMuDGE Documentation',
...
man_pages = [
    (master_doc, 'smudge', u'SMuDGE Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SMuDGE', u'SMuDGE Documentation',
     author, 'SMuDGE', 'One line description of project.',
     'Miscellaneous'),
]
...
extlinks = {'base_source': ('https://gitlab.lis-lab.fr/baptiste.bauvin/smudge/-/tree/master/', "base_source"),
            'base_doc': ('http://baptiste.bauvin.pages.lis-lab.fr/smudge/', 'base_doc')}
